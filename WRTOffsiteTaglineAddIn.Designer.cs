...
namespace WRTOffsite_NET35 {
    ...
    public sealed partial class WRTOffsiteTaglineAddIn : Microsoft.Office.Tools.Outlook.OutlookAddInBase {
        ...
        protected override void Initialize() {
            ...
            Globals.WRTOffsiteTaglineAddIn = this;
    ...
    internal sealed partial class Globals {
        ...
        internal static WRTOffsiteTaglineAddIn WRTOffsiteTaglineAddIn {
            get {
                return _WRTOffsiteTaglineAddIn;
            }
            set {
                if ((_WRTOffsiteTaglineAddIn == null)) {
                    _WRTOffsiteTaglineAddIn = value;
                }
                else {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.WRTOffsiteTaglineAddIn.GetFormRegions());
                }
